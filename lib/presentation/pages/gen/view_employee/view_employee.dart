...
class ViewEmployeePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      ...
      providers: [
        BlocProvider<ButtonStateCubit>(create: (context) => ButtonStateCubit()),
        BlocProvider<ViewEmployeeCubit>(
          create: (context) {
            final cubit = ViewEmployeeCubit(
              sl<UserAndLocaleService>(),
            ); // Get UserAndLocaleService from GetIt
  ...
  Widget _inEmployeeButton(BuildContext context, int employeeId) {
    return SuccessAppButton(
      ...
      onPressed: () {
        BlocProvider.of<ButtonStateCubit>(context).excute(
    ...
    if (validitycssclass != null && validitycssclass.startsWith('#')) {
      try {
        backgroundColor = Color(
          int.parse(validitycssclass.substring(1), radix: 16),
