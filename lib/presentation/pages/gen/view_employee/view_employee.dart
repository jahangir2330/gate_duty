...
import 'package:gipms/service_locator.dart'; // Import the service locator
import 'package:gipms/core/utils/user_and_locale_service.dart'; // Import the UserAndLocaleService
...
class ViewEmployeePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider<ButtonStateCubit>(
      ...
      child: BlocProvider(
        create: (context) {
          //final cubit = ViewEmployeeCubit(); // Removed
          final cubit = ViewEmployeeCubit(sl<
              UserAndLocaleService>()); // Get UserAndLocaleService from GetIt
                              ...
                              children: [
                                ...
                                _buildValidityStatus(
                                  ...
                                  AppLocalizations.of(context)!
                                      .validitystatusname,
                                  employee.validitystatusname,
                                  employee.validitycssclass,
                                ),
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  _buildProfileDetail(
                                    context,
                                    AppLocalizations.of(context)!.allowedGates,
  ...
  Widget _buildValidityStatus(BuildContext context, String label, String? value,
      String? validitycssclass) {
    Color? backgroundColor;
    if (validitycssclass != null && validitycssclass.startsWith('#')) {
      try {
        backgroundColor =
            Color(int.parse(validitycssclass.substring(1), radix: 16))
                .withOpacity(0.2); // Add some transparency
      } catch (e) {
        // Handle invalid hex color format if needed
        print("Invalid hex color: $validitycssclass - $e");
      }
    }
...
//   }
// }
//   // If need Place it to above Widget _buildDateTimeText(BuildContext context, String label, dynamic value) {
//   //   String displayText;
